...
#
# ENV INSTALL_PATH /aws_monitor
# # The name of the application is aws_monitor and while there
...
# # having to CD into the /aws_monitor folder every time would be
# # lame, so instead we can set the WORKDIR to be /aws_monitor.
# #
...
# # aws_monitor/ path inside of the Docker image.
# #
# # It copies it to /aws_monitor because of the WORKDIR being set.
# #
...
# # /aws_monitor folder inside of the Docker image.
# #
